...
void SystGammaSUMc(){          // -LamCosPAvar
   ...
   */
   ...
   TFile *fpol2 = TFile::Open("Syst_fitFunction.root-Gamma-pTPos-cut-9nov16.root");
   TFile *fpol3 = TFile::Open("Syst_fitFunction.root-Gamma-pTNeg-cut-9nov16.root");
