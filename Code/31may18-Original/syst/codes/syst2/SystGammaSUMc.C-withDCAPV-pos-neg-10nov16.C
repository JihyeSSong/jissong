...
void SystGammaSUMc(){          // -LamCosPAvar
   ...
   */
   ...
   TFile *fpol11 = TFile::Open("Syst_fitFunction.root-Gamma-pTPos-cut-9nov16.root");
   TFile *fpol12 = TFile::Open("Syst_fitFunction.root-Gamma-pTNeg-cut-9nov16.root");
  ...
  for(int ii=2; ii<ptbin+2; ii++) {
   ...
   pol10=hpol10->GetBinContent(ii);  pol11=hpol11->GetBinContent(ii);   pol12 =hpol12->GetBinContent(ii);
    ...
    pl10 =hpl10->GetBinContent(ii);  pl11 =hpl11->GetBinContent(ii);   pl12 =hpl12->GetBinContent(ii);
