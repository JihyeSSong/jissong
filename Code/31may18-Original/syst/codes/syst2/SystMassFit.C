...
void SystMassFit(){
   ...
   */
   ...
   /* Oct 3 
    TFile *fpol5 = TFile::Open("../ss1/SigMac.root-HISTO-MixCount-3oct16");
    TFile *fpol4 = TFile::Open("../ss1/SigMac.root-HISTO-MixGauss-3oct16");
    TFile *fpol1 = TFile::Open("../ss1/SigMac.root-HISTO-PolGauss-3oct16");
    TFile *fpol3 = TFile::Open("../ss1/SigMac.root-HISTO-PolCount-3oct16");
   */




    TFile *fpol5 = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-MixCount-17oct16.root");
    TFile *fpol4 = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-MixGauss-17oct16.root");
    TFile *fpol1 = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-PolGauss-17oct16.root");
	...
	*/
	  ...
	  yMpol3_e[ii]=1.e-4 ; // *yMpol3[ii]*sqrt(sqrt(d3)/d3*sqrt(d3)/d3+sqrt(mix)/mix*sqrt(mix)/mix);            
        ...
        printf(" dev3 %f 4 %f 5 %f 1 %f ii %d \n",yMpol3[ii], yMpol4[ii],  yMpol5[ii], yMpol1[ii],  ii );
   ...
   TH1D *hdmean4 = new TH1D("hdmean4","Mean deviation of 4 differences",ptbin+1,ptedges);
    ...
    legl->AddEntry(hdiff3,"pol,bin","lp");
    legl->AddEntry(hdiff4,"mix,gauss","lp");
    legl->AddEntry(hdiff5,"mix,bin","lp");
    legl->Draw("same");
