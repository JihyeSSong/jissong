...
void SystMassFit32(){          // -LamCosPAvar
  ...
  /* var 12
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-RatRows-cut1-8nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-RatRows-cut2-8nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-RatRows-cut3-8nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-RatRows-cut4-8nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-RatRows-cut5-8nov16.root");
     */
  /* var 13a
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut2-10nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut4-10nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut6-10nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut8-10nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut10-10nov16.root");
   */
   /* var 13b
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut5-10nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut6-10nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut7-10nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut8-10nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut9-10nov16.root");
   */


   /* var 14
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut5-10nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut7-10nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut6-10nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut8-10nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut9-10nov16.root");
     */

   /*   TFile *fmix = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-MixCount-17oct16.root");
   TFile *fpol1 = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-MixGauss-17oct16.root");
   TFile *fpol2 = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-PolGauss-17oct16.root");
   TFile *fpol3 = TFile::Open("../../oct16/ss1/SigMac-v44-Bins2a-noTTRee-PolCount-17oct16.root");
   */
 
   /*   TFile *fmix  = TFile::Open("../../oct16/ss1/SigMac-v45-TTree-PolGauss-Bins2b-BgSigFist-BASE-21oct16.root");
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-PolGauss-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol2 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-PolCount-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol3 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-MixGauss-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol4 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-MixCount-IKY-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol5 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-MixCount-ABB2-Bins2b-BgSigFist-21oct16.root");
   */

   /* v1-11nov16 
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-Bins2b-BgSig-Pol3Gauss-11nov16.root");
   TFile *fpol1 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-PolGauss-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-Bins2b-BgSig-Pol3Count-11nov16.root");
   TFile *fpol3 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-MixGauss-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol4 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-MixCount-IKY-Bins2b-BgSigFist-21oct16.root");
   TFile *fpol5 = TFile::Open("../../oct16/ss1/SigMac-v44-noTTree-MixCount-ABB2-Bins2b-BgSigFist-21oct16.root");
   */
   ...
   /* v2-11nov16 
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   //   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-Bins2b-BgSig-Pol3Gauss-11nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixGauss-ab21oct16-11nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-Bins2b-BgSig-Pol3Count-11nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixGauss-iky-11nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab6jun16-11nov16.root");
   //  TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab21oct16-11nov16.root");
   //   TFile *fpol5 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-iky-11nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-Pol2Count-11nov16.root");
   */

  /* v2-14nov16 
    TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixGauss-iky6jul16-14nov16.root");
   // TFile *fpol2 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-iky6jul16-14nov16.root");
 TFile *fpol2 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab6jun16-14nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-Pol3Gauss-14nov16.root");
   //   TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-TTree-Bins2b-BgSig-Pol3Gauss-14nov16.root");
 TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab21oct16-14nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-Bins2b-BgSig-Pol3Count-14nov16.root");
     */
 ...
 TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab21oct16-14nov16.root");
   ...
   */
   ...
   /* v0-24apr17 v606 -606-rel606-v100-23oct17
    TFile *fmix = TFile::Open("../ss1/SigMac.root-v606-Pol3Gaus-24apr17.root");

/   TFile *fmix = TFile::Open("../ss1/SigMac.root-v605-fixedM-STAND-24apr17.root"); 
   TFile *fpol1 = TFile::Open("../ss1/SigMac.root-v606-Pol3Count-24apr17.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac.root-v606-MixGaus-24apr17.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac.root-v606-MixCount-24apr17.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac.root-v606-Pol4Gaus-24apr17.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac.root-v606-Pol4Count-24apr17.root");
     */
   

    /* v0-24apr17 v605 
    TFile *fmix = TFile::Open("../ss1/SigMac.root-v605-Pol3Gaus-24apr17.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac.root-v605-fixedM-STAND-24apr17.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac.root-v605-Pol3Count-24apr17.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac.root-v605-MixGaus-24apr17.root");
   //   TFile *fpol3 = TFile::Open("../ss1/SigMac.root-v605-MixCount-24apr17.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac.root-v605-Pol4Gaus-24apr17.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac.root-v605-Pol4Count-24apr17.root");
    */

    TFile *fmix = TFile::Open("../ss1/SigMac-Tree-Pol2-Gauss-STANDARD-27oct17.root");

    //-v31  TFile *fpol1 = TFile::Open("../ss1/SigMac-mixBG-IKY6jun-Nocount-27oct17.root");

    TFile *fpol1 = TFile::Open("../ss1/SigMac-Tree-pol2BG-Count-27oct17.root");
    TFile *fpol2 = TFile::Open("../ss1/SigMac-Tree-MixBG-abb21oct16-Gauss-27oct17.root");
    TFile *fpol3 = TFile::Open("../ss1/SigMac-Tree-MixBG-abb6jun16-iMixPolTrue-Gauss-27oct17.root");
    TFile *fpol4 = TFile::Open("../ss1/SigMac-Tree-MixBG-iky6jun16-iMixPolTrue-Gauss-27oct17.root");
    TFile *fpol5 = TFile::Open("../ss1/SigMac-Tree-MixBG-abb21oct16-iMixPolTrue-Gauss-27oct17.root");
   ...
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-Bins2b-BgSig-Pol3Count-11nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixGauss-iky-11nov16.root");
  TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixGauss-iky6jul16-14nov16.root");
   //    TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab21oct16-14nov16.root");
  //TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab6jun16-14nov16.root");
   //-- TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab6jun16-11nov16.root");
   //  TFile *fpol4 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-ab21oct16-11nov16.root");
   //   TFile *fpol5 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-MixCount-iky-11nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v44-noTTree-Bins2b-BgSig-Pol2Count-11nov16.root");
 ...
 */
  ...
  legl1->Draw("same");
    ...
    boxU->SetYTitle("(1/N_{ev}) d^{2}N/dydp_{T}, (GeV/c)^{-1}");
