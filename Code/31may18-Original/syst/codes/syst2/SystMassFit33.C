...
void SystMassFit33(){          // -LamCosPAvar
 ...
 */
   ...
   //v32  TFile *fpol2 = TFile::Open("../ss1/SigMac-Tree-MixBG-abb21oct16-Gauss-27oct17.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-Tree-pol3BG-Gauss-27oct17.root");
