...
void SystMassFit34(){          // -LamCosPAvar
...
/   TFile *fmix = TFile::Open("../ss1/SigMac.root-v605-fixedM-STAND-24apr17.root"); 
  ...
  TFile *fmix = TFile::Open("../ss1/SigMac-Tree-Pol2-Gauss-STANDARD-27oct17.root");
   ...
   //v33  TFile *fpol2 = TFile::Open("../ss1/SigMac-Tree-pol3BG-Gauss-27oct17.root");

   TFile *fpol2 = TFile::Open("../ss1/SigMac-Tree-pol3BG-Count-27oct17.root");
