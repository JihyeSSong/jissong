void plotSum_9sep15()
{
  ...
  gStyle->SetOptStat(11111);       // global options for ALL plots
  ...
  TFile * f1 = new TFile("SystStudy-Sigma0-fpol3.root");
  TFile * f2 = new TFile("SystStudy-Sigma0-fpol4.root");
  TFile * f3 = new TFile("SystStudy-Sigma0-fpol5.root");

  TH1D* hr1=(TH1D*) f1->Get("hRatDiff");
  TH1D* hr2=(TH1D*) f2->Get("hRatDiff");
  TH1D* hr3=(TH1D*) f3->Get("hRatDiff");
...
TH1F *boxS = new TH1F("boxS","Ratio",300,0.,30.);
  boxS->SetAxisRange(-10.0, 10.0, "X");
  boxS->SetAxisRange(0., 1.e1, "Y");
  boxS->SetXTitle("ratio");
  boxS->SetYTitle("Entries");
