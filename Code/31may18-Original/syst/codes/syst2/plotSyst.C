void plotSyst()
{
  ...
  TH1F *boxE = new TH1F("boxE","Anti-Sigma vs Sigma",300,0.,30.);
  ...
  Int_t nBin = 9;
  //  Double_t diff[nBin], reldiff[nBin],pt[nBin],ept[nBin];
  Double_t diff[9], ediff[9],reldiff[9],ereldiff[9],relstat[9],erelstat[9],pt[9],ept[9],pts[9];
  Double_t deltacc[9], ratdiff[9];

  //    TFile * f1 = new TFile("Sigma0AP-p2-46-2010-Pt.root");
  //  TFile * f1 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2103.root"); 
  //    TFile * f1 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2004-29jun-DT.root"); 

  //   TFile * f1 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2004-29jun-MC.root"); 

  TFile * f1 = new TFile("Sigma0-A-p2-50-2010-Pt-bins0004-2jul15.root");

  // TGraphErrors  *stat1 = (TGraphErrors*)f2->Get("data_stat");

  TGraphErrors  *stat1 = (TGraphErrors*)f1->Get("data_syst");
  
    //    TFile * f2 = new TFile("Sigma0AP-p2-50-2010-Pt.root");
  //   TFile * f2 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2003.root"); 
  //  TFile * f2 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2013.root"); 
  //  TFile * f2 = new TFile("Sigma0AP-p2-46-2010-Pt-26jun15-bins2005.root"); 
  //     TFile * f2 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2114-29jun-DT.root");
  //    TFile * f2 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2104-29jun-DT.root"); 
  // TFile * f2 = new TFile("Sigma0AP-p2-50-2010-Pt-bins2014-29jun-DT.root"); 
  //  TFile * f2 = new TFile("Sigma0AP-p2-46-2010-Pt-bins2004-.root");
  //  TFile * f2 = new TFile("Sigma0AP-p2-46-2010-Pt-bins2005-totalerr.root");

  TFile * f2 = new TFile("Sigma0-P-p2-50-2010-Pt-bins1004-2jul15.root");

 TGraphErrors  *stat2 = (TGraphErrors*)f2->Get("data_syst");
 //  TGraphErrors  *stat2 = (TGraphErrors*)f2->Get("data_stat");
  ...
  Double_t fcorr = 1.0;
    ...
    TH1F *boxS = new TH1F("boxS","Relative Variation, Syst: 0.195 +- 0.070",300,0.,30.);
...
TCanvas *crelsys = new TCanvas("crelsys2","Rel2. Syst. Error",0,0,800,800);
