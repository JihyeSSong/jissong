void plotSystStudy()
{
 ...
 TFile * f1 = new TFile("../ss1/SigMac-v44-Bins2a-noTTRee-PolGauss-17oct16.root");
 TGraphErrors  *stat1 = (TGraphErrors*)f1->Get("gr_stat");
 // TH1D *stat1 = (TH1D*)f1->Get("stat"); 
  ...
  TGraphErrors  *stat2 = (TGraphErrors*)f2->Get("gr_stat");
