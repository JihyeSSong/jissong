...
/* 0*/    tTreeEvent->Branch("fLambdaMod",&fLambdaMod,"fLambdaMod/D");
/* 1*/    tTreeEvent->Branch("fLambdaPx",&fLambdaPx, "fLambdaPx/D");
/* 2*/    tTreeEvent->Branch("fLambdaPy",&fLambdaPy, "fLambdaPy/D");
/* 3*/    tTreeEvent->Branch("fLambdaPz",&fLambdaPz, "fLambdaPz/D");
/* 4*/    tTreeEvent->Branch("fLambdaMass",&fLambdaMass, "fLambdaMass/D");
/* 5*/    tTreeEvent->Branch("fLambdaCosPointingAngle",&fLambdaCosPointingAngle,"fLambdaCosPointingAngle/D");
/* 6*/    tTreeEvent->Branch("fLambdaDCADaughters",&fLambdaDCADaughters,"fLambdaDCADaughters/D");
/* 7*/    tTreeEvent->Branch("fLambdaDCAtoPVNeg",&fLambdaDCAtoPVNeg,"fLambdaDCAtoPVNeg/D");
/* 8*/    tTreeEvent->Branch("fLambdaDCAtoPVPos",&fLambdaDCAtoPVPos,"fLambdaDCAtoPVPos/D");
/* 9*/    tTreeEvent->Branch("fLambdaRadius",&fLambdaRadius,"fLambdaRadius/D");
/*10*/    tTreeEvent->Branch("fLambdaArmPt",&fLambdaArmPt,"fLambdaArmPt/D");
/*11*/    tTreeEvent->Branch("fLambdaArmAlpha",&fLambdaArmAlpha,"fLambdaArmAlpha/D");
/*12*/    tTreeEvent->Branch("fLambdaEta",&fLambdaEta,"fLambdaEta/D");
    
/*13*/    tTreeEvent->Branch("fGammaPx",&fGammaPx, "fGammaPx/D");
/*14*/    tTreeEvent->Branch("fGammaPy",&fGammaPy, "fGammaPy/D");
/*15*/    tTreeEvent->Branch("fGammaPz",&fGammaPz, "fGammaPz/D");
/*16*/    tTreeEvent->Branch("fGammaMass",&fGammaMass, "fGammaMass/D");
/*17*/    tTreeEvent->Branch("fGammaCosPointingAngle",&fGammaCosPointingAngle,"fGammaCosPointingAngle/D");
/*18*/    tTreeEvent->Branch("fGammaRadius",&fGammaRadius,"fGammaRadius/D");
/*19*/    tTreeEvent->Branch("fGammaArmPt",&fGammaArmPt,"fGammaArmPt/D");
/*20*/    tTreeEvent->Branch("fGammaArmAlpha",&fGammaArmAlpha,"fGammaArmAlpha/D");
/*21*/    tTreeEvent->Branch("fGammaEta",&fGammaEta,"fGammaEta/D");
/*22*/    tTreeEvent->Branch("fGammaChi2",&fGammaChi2,"fGammaChi2/D");
/*23*/    tTreeEvent->Branch("fGammaZConv",&fGammaZConv,"fGammaZConv/D");
    
/*24*/    tTreeEvent->Branch("fSigmaMass",&fSigmaMass,"fSigmaMass/D");
/*25*/    tTreeEvent->Branch("fSigmaPt",&fSigmaPt, "fSigmaPt/D");
/*26*/    tTreeEvent->Branch("fSigmaArmPt",&fSigmaArmPt,"fSigmaArmPt/D");
/*27*/    tTreeEvent->Branch("fSigmaArmAlpha",&fSigmaArmAlpha,"fSigmaArmAlpha/D");
/*28*/    tTreeEvent->Branch("fCentr",&fCentr,"fCentr/D");
...
void AliAnalysisTaskSigma0::SelectLambda(){
    ...
    for(Int_t iv0=0; iv0<nV0;iv0++){
        ...
        Double_t lDcaV0Daughters = v0->GetDcaV0Daughters();
        ///////////////values for cuts//////////////////////////////////
        if ((lDcaPosToPrimVertex < 0.1) || (lDcaNegToPrimVertex < 0.1) ||(lV0cosPointAngle < 0.998) || (lV0Radius < 0.0) || (lV0Radius > 100. ) ) continue;
