...
// include path
   ...
   gSystem->AddIncludePath("-Wno-deprecated -I$. -I$CGAL_DIR/include -I$FASTJET/include -I$ROOTSYS/include -I$ALICE_ROOT/include -I$ALICE_PHYSICS/include ");
...
// analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliAnalysisTaskSkeleton.cxx+g");

// read the analysis manager from file
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("AliMultSelectionTest.root");
   if (!mgr) return;
   mgr->PrintStatus();
