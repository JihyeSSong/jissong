...
root -b -q -x AliMultSelectionTest.C 
RET=$?
if [ "$RET" != "0" ];then
  echo "======== ERROR : AliMultSelectionTest.C finished with NON zero code: $RET ========"
...
echo "======== AliMultSelectionTest.C finished with exit code: $RET ========"
echo "############## memory after: ##############"
free -m
