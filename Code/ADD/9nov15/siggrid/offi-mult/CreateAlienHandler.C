...
// loaded by the generated analysis macro. Add all extra files (task .cxx/.h) here.
    plugin->SetAdditionalLibs("libOADB.so AliAnalysisTaskSkeleton.h AliAnalysisTaskSkeleton.cxx");
...
// Optionally set a name for the generated analysis macro (default MyAnalysis.C)
    plugin->SetAnalysisMacro("AliMultSelectionTest.C");
// Optionally set maximum number of input files/subjob (default 100, put 0 to ignore)
    plugin->SetSplitMaxInputFileNumber(50);
// Optionally modify the executable name (default analysis.sh)
    plugin->SetExecutable("AliMultSelectionTest.sh");
...
// Optionally modify the name of the generated JDL (default analysis.jdl)
    plugin->SetJDLName("AliMultSelectionTest.jdl");
