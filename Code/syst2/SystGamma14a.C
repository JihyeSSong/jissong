...
void SystGamma01(){          // -LamCosPAvar
  ...
  /* var 13
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut6-9nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut5-9nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut3-9nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut4-9nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTPos-cut5-9nov16.root");
      */
   /* var 13
   TFile *fmix = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-BASE-7nov16.root");
   TFile *fpol1 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut6-9nov16.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut7-9nov16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut3-9nov16.root");
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut4-9nov16.root");
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-Gamma-pTNeg-cut5-9nov16.root");
    */
