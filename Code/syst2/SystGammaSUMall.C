...
void SystGammaSUMall(){          // -LamCosPAvar
  ...
  for(int i=1; i<ptbin+5; i++){
   ...
   //  
   /*    TFile *fpol0 = TFile::Open("Syst_fitFunction.root-var4c-fLambdaMassCut6-2nov16.root");
   TFile *fpol1 = TFile::Open("Syst_fitFunction.root-var5c-LamCosPA-1nov16.root");

   TFile *fpol9 = TFile::Open("Syst_fitFunction.root-var10c-RatioRawsVar-31oct16.root");
   TFile *fpol6 = TFile::Open("Syst_fitFunction.root-var11c-LamDCAtoPVNeg-1nov16.root");
   TFile *fpol3 = TFile::Open("Syst_fitFunction.root-var12c-LambdaK0sDiff-1nov16.root");
   TFile *fpol2 = TFile::Open("Syst_fitFunction.root-var13c-LambdaSigmasProton-28oct16.root");
   TFile *fpol8 = TFile::Open("Syst_fitFunction.root-var14c-LamRadius-31oct16.root");
   TFile *fpol4 = TFile::Open("Syst_fitFunction.root-var6c-LamDCAD-cut7-28oct16.root");
   TFile *fpol5 = TFile::Open("Syst_fitFunction.root-var7c-LamDCAtoPVPos-cut5-28oct16.root");
   TFile *fpol7 = TFile::Open("Syst_fitFunction.root-var9c-cTauVar-cut6-28oct16.root");
   */

   //- 
  TFile *fpol0 = TFile::Open("Syst_fitFunction.root-Gamma-RatRows-cut-8nov16.root");
   //- 
  TFile *fpol1 = TFile::Open("Syst_fitFunction.root-Gamma-DCADaught-cut-8nov16.root");
   //  TFile *fpol2 = TFile::Open("Syst_fitFunction.root-Gamma-CosPA-cut-8nov16.root");
   //   TFile *fpol2 = TFile::Open("Syst_fitFunction.root-Gamma-DCAPVpos-cut-10nov16.root");
   // TFile *fpol3 = TFile::Open("Syst_fitFunction.root-Gamma-DCAPVneg-cut-8nov16.root");

   //-
   TFile *fpol4 = TFile::Open("Syst_fitFunction.root-Gamma-DCAztoPV-cut-8nov16.root");
   TFile *fpol5 = TFile::Open("Syst_fitFunction.root-Gamma-Chi2-cut5-8nov16.root");
   //-
   TFile *fpol6 = TFile::Open("Syst_fitFunction.root-Gamma-Radius-cut-8nov16.root");
   TFile *fpol7 = TFile::Open("Syst_fitFunction.root-Gamma-NsigePos-cut-8nov16.root");
   TFile *fpol8 = TFile::Open("Syst_fitFunction.root-Gamma-NsigeNeg-cut-8nov16.root");
   TFile *fpol9 = TFile::Open("Syst_fitFunction.root-Gamma-NsigPiNeg-cut5-8nov16.root");
   TFile *fpol10 = TFile::Open("Syst_fitFunction.root-Gamma-NsigPiPos-cut5-9nov16.root");
   //- 
TFile *fpol2 = TFile::Open("Syst_fitFunction.root-Gamma-pTPos-cut-10nov16.root");
   //- 
  TFile *fpol3 = TFile::Open("Syst_fitFunction.root-Gamma-pTNeg-cut-10nov16.root");
  ...
  for(int ii=2; ii<ptbin+2; ii++) {
    Double_t apol0 =hpol0->GetBinContent(ii);
    printf(" val %f \n", apol0);
  }
    ...
    //   TH1D *hpol11 = (TH1D*)fpol11->Get("hdmeandiff"); 
    //    TH1D *hpol12 = (TH1D*)fpol12->Get("hdmeandiff");
    ...
    TH1D *hpl10 = (TH1D*)fpol10->Get("hmeandiff");  
 
    //   TH1D *hpl11 = (TH1D*)fpol11->Get("hmeandiff"); 
    // TH1D *hpl12 = (TH1D*)fpol12->Get("hmeandiff");
 ...
 pol5 =hpol5->GetBinContent(ii);
     pol6 =hpol6->GetBinContent(ii); 
 pol7 =hpol7->GetBinContent(ii); 
  pol8 =hpol8->GetBinContent(ii);
    pol9 =hpol9->GetBinContent(ii);  
     pol0 =hpol0->GetBinContent(ii); 
    pol10=hpol10->GetBinContent(ii); 
    //-no    pol11=hpol11->GetBinContent(ii);   pol12 =hpol12->GetBinContent(ii);
    ...
    yMmean[ii] = sqrt ( pol1*pol1 + pol2*pol2 + pol3*pol3 + pol4*pol4 + pol5*pol5 +
		  ...
		  pol10*pol10 + pol11*pol11 + pol12*pol12  ); 
    
    Double_t ym0 =  sqrt ( pol0*pol0 ) ;
    printf("ym0 %f i %d \n",ym0, ii );
    printf("pol0 %f 1 %f 2 %f 3 %f 4 %f 5 %f 6 %f 7 %f 8 %f 9 %f Mean %f \n"
	 ,pol0 ,pol1,pol2,pol3,pol4,pol5,pol6,pol7,pol8,pol9,  yMmean[ii]);



    double pl0 = 0; 
    double pl1 = 0;  double pl2 = 0;  double pl3 = 0;   double pl4 = 0; 
    double pl5 = 0;
    double pl6 = 0;  double pl7 = 0;  double pl8 = 0;   double pl9 = 0; double pl10 = 0;
    double pl11 = 0;  double pl12 = 0; 

    // pl0 =hpl0->GetBinContent(ii);  
    //    pl1 =hpl1->GetBinContent(ii);  pl2 =hpl2->GetBinContent(ii);   pl3 =hpol3->GetBinContent(ii);
    //  pl4 =hpl4->GetBinContent(ii);  
  pl5 =hpl5->GetBinContent(ii);
  //  pl6 =hpl6->GetBinContent(ii); 
  pl7 =hpl7->GetBinContent(ii); 
  pl8 =hpol8->GetBinContent(ii);
    pl9 =hpl9->GetBinContent(ii);  
 
    pl10 =hpl10->GetBinContent(ii); 
    //  pl11 =hpl11->GetBinContent(ii);   pl12 =hpl12->GetBinContent(ii);

   yMean[ii] = sqrt ( pl1*pl1 + pl2*pl2 + pl3*pl3 + pl4*pl4 + pl5*pl5 +
			    pl6*pl6 + pl7*pl7 + pl8*pl8 + pl9*pl9 + pl0*pl0 +
		     pl10*pl10 + pl11*pl11 + pl12*pl12   ); 
    
    printf(" pl0 %f 1 %f 2 %f 3 %f 4 %f 5 %f 6 %f 7 %f 8 %f 9 %f Mean %f \n \n"
	   ,pl0 ,pl1,pl2,pl3,pl4,pl5,pl6,pl7,pl8,pl9,  yMean[ii]);
  }
 ...
 hSystDSum ->SetXTitle("p_{T}, GeV/c");
 ...
 hSystDSum->Draw();
 hSystMSum->Draw("same");
 TLegend *legl = new TLegend(0.6,0.5,0.9,0.9);
 legl->AddEntry(hSystDSum,"RMS of deviations","lp");
 legl->AddEntry(hSystMSum,"Mean difference","lp");
  legl->Draw("same");
