...
void SystLambda000c(){          // -LamCosPAvar
  ...
  for(int i=1; i<ptbin+5; i++){
   ...
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-LamCut6.root");
   */
   ...
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-LamCosPA6-19oct16.root");
  */
   ...
   TFile *fpol5 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LamDCAD-cut3-19oct16.root");
   ...
   TFile *fpol4 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LamDCAD-cut6-28oct16.root");
   TFile *fpol3 = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LamDCAD-cut7-28oct16.root");
   */
   ...
   */
   ...
   // * 10 RatioRaws
   /* ver1-31oct16 BEST
   //   TFile *fpol2  = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-BASE-19oct16.root");

   TFile *fpol1 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut1-24oct16.root");
   TFile *fpol2 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut12-31oct16.root"); 
   TFile *fpol5 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut8-31oct16.root");
   //   TFile *fpol3 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut3-24oct16.root");
   TFile *fpol3 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut10-31oct16.root");
   //   TFile *fpol4 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut4-24oct16.root");
   //   TFile *fpol2 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut5-24oct16.root");
   //   TFile *fpol4 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut7-31oct16.root"); 
    TFile *fpol4 =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut9-31oct16.root"); 
  
    //  TFile *fmix =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut6-28oct16.root");
    TFile *fmix =TFile::Open("../ss1/SigMac-v45-TTree-PolCount-Bins2b-RatioRawsVar-cut11-31oct16.root");
    */
   ...
   // * 12 LambdaK0sDiff - BEST-31oct16    OPEN-28oct16
   //  TFile *fmix  = TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-BASE-19oct16.root");
   ...
   // TFile *fpol4 =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut7-28oct16.root");
   TFile *fpol5 =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut5-25ct16.root");
   //  TFile *fpol5 =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut6-28oct16.root");
   
  TFile *fpol4 =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut7-31oct16.root");
  // TFile *fpol5 =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut9-31oct16.root");

  //  TFile *fmix =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut8-31oct16.root");
  TFile *fmix =TFile::Open("../ss1/SigMac-v45-TTree-PolGauss-Bins2b-LambdaK0sDiff-cut10-31oct16.root");
  //  */
   ...
   */
   ...
   /*  var14   LambdaRadius - BEST-31oct16 
