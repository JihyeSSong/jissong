...
void SystLambdaMass4(){
  ...
  //      gStyle->SetOptStat(111111);
   ...
   hRelStat1->SetLineWidth(2);   hRelStat1->SetMinimum(0.001);   hRelStat1->SetMaximum(1.5);
   ...
   hRelStat2->SetLineWidth(2);        hRelStat2->SetMinimum(0.001);    hRelStat2->SetMaximum(1.5);
   ...
   hRelStat3->SetLineWidth(2);   hRelStat3->SetMinimum(0.001);   hRelStat3->SetMaximum(1.5);
   ...
   hRelStat4->SetLineWidth(2);   hRelStat4->SetMinimum(0.001);   hRelStat4->SetMaximum(1.5);
   ...
   hRelStat5->SetLineWidth(2);   hRelStat5->SetMinimum(0.001);   hRelStat5->SetMaximum(1.5);
