...
void SystMassFit36(){          // -LamCosPAvar
...
/   TFile *fmix = TFile::Open("../ss1/SigMac.root-v605-fixedM-STAND-24apr17.root"); 
   ...
   TFile *fmix = TFile::Open("../ss1/SigMac-Tree-Pol3-Gauss-STANDARD2-29oct17.root");
   

   TFile *fpol1 = TFile::Open("../ss1/SigMac-Tree-pol2BG-Count-27oct17.root");
   TFile *fpol2 = TFile::Open("../ss1/SigMac-Tree-Pol2-Gauss-STANDARD-27oct17.root");
   ...
   //v34   TFile *fpol3 = TFile::Open("../ss1/SigMac-Tree-MixBG-abb6jun16-iMixPolTrue-Gauss-27oct17.root");

   TFile *fpol3 = TFile::Open("../ss1/SigMac-Tree-pol3BG-Count-27oct17.root");
