...
void SystLambda000b(){          // -LamCosPAvar
 ...
 for(int ii=nrangem2; ii<=nrangep2; ii++) {
  diffsum +=    hRatDiffSum->GetBinContent(ii);  
 }
 ...
 printf("+-2sigma sum %f ratio %f rest %f    +-1sigma  sum1 %f ratio1 %f rest1 %f \n",
	diffsum,  diffsum/40, 40 - diffsum, diffsum1,  diffsum1/40, 40 - diffsum1 ); 
 // printf("m1 %d nrangep1 %d sum1 %f ratio1/40 %f \n",nrangem1, nrangep1,diffsum1,  diffsum1/40 ); 



 TLine *line = new TLine(-5, diffsum/40,-2,  diffsum/40);
 TLine *linedef = new TLine(-5, 0.9545, -2 ,  0.9545);
 linedef->SetLineColor(kRed);
  line->SetLineColor(kBlue);
  line->Draw("same");
  linedef->Draw("same");

 TLine *line1 = new TLine(-5, diffsum1/40,-1,  diffsum1/40);
 TLine *linedef1 = new TLine(-5, 0.6827, -1 ,  0.6827);
 linedef->SetLineColor(kRed);
 linedef->SetLineWidth(2);
  line->SetLineColor(kBlue);
 line->SetLineWidth(2);
  line->Draw("same");
  linedef->Draw("same");
