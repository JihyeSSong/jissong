...
double yilel2[ptbin+1]={0};
double yiell2_e[ptbin+1]={0};
...
void SystLambda9(){
 ...
 for(int i=2; i<ptbin+2; i++){
   hRatDiffPt[i-1]= new TH1D(Form("hRatDiffPt_%d",i-1),Form("RatDiffPt_%d",i-1), 100, -5, 5 );
   hRatDiffPt[i-1]->SetMarkerStyle(21);
   hRatDiffPt[i-1]->SetMarkerSize(0.5);
   hRatDiffPt[i-1]->SetLineColor(kRed-3);
   hRatDiffPt[i-1]->SetMarkerColor(kRed-3);
 }
  ...
  TH1D *hyielbase = (TH1D*)fmix->Get("h_Rawspectrum");    
  TH1D *hyiel1 = (TH1D*)ffpol1->Get("h_Rawspectrum");    
  TH1D *hyiel2 = (TH1D*)ffpol2->Get("h_Rawspectrum");    
  TH1D *hyiel3 = (TH1D*)ffpol3->Get("h_Rawspectrum");    
  TH1D *hyiel4 = (TH1D*)ffpol4->Get("h_Rawspectrum");    
  TH1D *hyiel5 = (TH1D*)ffpol5->Get("h_Rawspectrum");    
  ...
  for(int ii=2; ii<ptbin+2; ii++) {
    ...
    double yiel1_e[ii]= 1.e-6; double yiel2_e[ii]= 1.e-6; 
    double yiel3_e[ii]= 1.e-6; double yiel4_e[ii]= 1.e-6; double yiel5_e[ii]= 1.e-6;

    yieldbase =hyielbase->GetBinContent(ii);
    yiel1[ii] =1- hyiel1->GetBinContent(ii)/yieldbase;  yiel2[ii] =1- hyiel2->GetBinContent(ii)/yieldbase;   
    yiel3[ii] =1- hyiel3->GetBinContent(ii)/yieldbase;  yiel4[ii] =1- hyiel4->GetBinContent(ii)/yieldbase;  
    yiel5[ii] =1- hyiel5->GetBinContent(ii);
  ...
  hyie1->SetTitle("cut1");
  for(int i=2; i<ptbin+2; i++) {
    hyie1->SetBinContent(i,yiel1[i]);        hyie1->SetBinError(i,yiell1_e[i]);    }

  TH1D *hyie2 = new TH1D("hyie2","SigLoss2",ptbin+1,ptedges);
  hyie2->SetLineColor(kRed+3);
  hyie2->SetMarkerColor(kRed+3);
  hyie2->SetLineWidth(2);
  hyie2->SetMinimum(0.001);
  hyie2->SetMaximum(1.5);
  hyie2->SetMarkerSize(1.5);
  hyie2->SetMarkerStyle(23);
  hyie2->SetTitle("cut1");
  for(int i=2; i<ptbin+2; i++) {
    hyie2->SetBinContent(i,yiel2[i]);        hyie1->SetBinError(i,yiell2_e[i]);    }

  TH1D *hyie3 = new TH1D("hyie3","SigLoss3",ptbin+1,ptedges);
  hyie3->SetLineColor(kRed+3);
  hyie3>SetMarkerColor(kRed+3);
  hyie3>SetLineWidth(2);
  hyie3->SetMinimum(0.001);
  hyie3->SetMaximum(1.5);
  hyie3->SetMarkerSize(1.5);
  hyie3->SetMarkerStyle(23);
  hyie3->SetTitle("cut1");
  for(int i=2; i<ptbin+2; i++) {
    hyie3->SetBinContent(i,yiel3[i]);        hyie1->SetBinError(i,yiell3_e[i]);    }

  TH1D *hyie4 = new TH1D("hyie4","SigLoss4",ptbin+1,ptedges);
  hyie4->SetLineColor(kRed+3);
  hyie4->SetMarkerColor(kRed+3);
  hyie4->SetLineWidth(2);
  hyie4->SetMinimum(0.001);
  hyie4->SetMaximum(1.5);
  hyie4->SetMarkerSize(1.5);
  hyie4->SetMarkerStyle(23);
  hyie4->SetTitle("cut1");
  for(int i=2; i<ptbin+2; i++) {
    hyie4->SetBinContent(i,yiel4[i]);        hyie1->SetBinError(i,yiell4_e[i]);    }

  TH1D *hyie5= new TH1D("hyie5","SigLoss5",ptbin+1,ptedges);
  hyie5->SetLineColor(kRed+3);
  hyie5->SetMarkerColor(kRed+3);
  hyie5->SetLineWidth(2);
  hyie5->SetMinimum(0.001);
  hyie5->SetMaximum(1.5);
  hyie5->SetMarkerSize(1.5);
  hyie5->SetMarkerStyle(23);
  hyie5->SetTitle("cut1");
  for(int i=2; i<ptbin+2; i++) {
    hyie5->SetBinContent(i,yiel5[i]);        hyie1->SetBinError(i,yiell5_e[i]);    }
   ...
   for(int i=2; i<ptbin+2; i++) {
    ...
    for(int ii=2; ii<ptbin+2; ii++) {
      ...
      hRatDiffPt[ii-1]->Fill( ratdiff1[ii] ); hRatDiffPt[ii-1]->Fill( ratdiff2[ii] ); hRatDiffPt[ii-1]->Fill( ratdiff3[ii] ); 
      hRatDiffPt[ii-1]->Fill( ratdiff4[ii] ); hRatDiffPt[ii-1]->Fill( ratdiff5[ii] ); 
   }
   ...
   TCanvas *cRatDiff = new TCanvas("cRatDiff","Rel Diff",0,0,800,1000);
  ...
  TCanvas *cRatDiffPt = new TCanvas("cRatDiffPt","Rel Diff in Pt",0,0,800,1000);
  gStyle->SetOptStat(1111);
  cRatDiffPt->Divide (3,3) ;
  for(int ll=2; ll<=ptbin+2; ll++){
     cRatDiffPt->cd(ll+1);
     gStyle->SetOptStat(0);
     gStyle->SetOptFit(0);
     hRatDiffPt[ll-1]->Draw("");
  }
