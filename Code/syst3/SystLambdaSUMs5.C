...
void SystLambdaSUMs5(){          // -LamCosPAvar
  ...
  for(int i=1; i<ptbin+5; i++){
   ...
   //   TFile *fpol0 = TFile::Open("Syst_fitFunction.root-var4c-fLambdaMassCut6-28oct16.root");
 ...
 pol3 =hpol3->GetBinContent(ii);
    ...
    // pol6 =hpol6->GetBinContent(ii);  pol7 =hpol7->GetBinContent(ii);  
   pol8 =hpol8->GetBinContent(ii);
    ...
    pl1 =hpl1->GetBinContent(ii); 
    // pl2 =hpl2->GetBinContent(ii);  
 pl3 =hpol3->GetBinContent(ii);
    pl4 =hpl4->GetBinContent(ii); 
    // pl5 =hpl5->GetBinContent(ii);
    // pl6 =hpl6->GetBinContent(ii);  pl7 =hpl7->GetBinContent(ii); 
