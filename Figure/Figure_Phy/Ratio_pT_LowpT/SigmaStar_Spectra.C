void SigmaStar_Spectra(){
    ...
    // from HEP http://hepdata.cedar.ac.uk/view/ins1300380
    ...
    Anti_SigmaPstat->Write("Anti_SigmaPstat");
    Anti_SigmaPsys->Write("Anti_SigmaPsys");
    
    Anti_SigmaMstat->Write("Anti_SigmaMstat");
    Anti_SigmaMsys->Write("Anti_SigmaMsys");
