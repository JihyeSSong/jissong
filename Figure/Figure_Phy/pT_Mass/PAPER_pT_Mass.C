...
// ------------>Primitives in pad: p2
   ...
   gre->Draw("[]");
    ...
    ////////////////////////////// Sigma 0 //////////////////////////////
    Double_t GraphSigma0Stat_fx1005[1] = {
        1.192};
    Double_t GraphSigma0Stat_fy1005[1] = {
        1.161};
    Double_t GraphSigma0Stat_fex1005[1] = {
        0.03};
    Double_t GraphSigma0Stat_fey1005[1] = {
        0.076};
    gre = new TGraphErrors(1,GraphSigma0Stat_fx1005,GraphSigma0Stat_fy1005,GraphSigma0Stat_fex1005,GraphSigma0Stat_fey1005);
    gre->SetName("GraphSigma0Stat");
    gre->SetTitle("GraphSigma0Stat");
    gre->SetFillColor(1);
    gre->SetFillStyle(0);
    ...
    TH1F *Graph_Graph_GraphSigma0Stat10051005 = new TH1F("Graph_Graph_GraphSigma0Stat10051005","GraphSigma0Stat",100,1.4958,1.5678);
    Graph_Graph_GraphSigma0Stat10051005->SetMinimum(1.6258);
    Graph_Graph_GraphSigma0Stat10051005->SetMaximum(1.6642);
    Graph_Graph_GraphSigma0Stat10051005->SetDirectory(0);
    Graph_Graph_GraphSigma0Stat10051005->SetStats(0);
    
    ci = TColor::GetColor("#000000");
    Graph_Graph_GraphSigma0Stat10051005->SetLineColor(ci);
    Graph_Graph_GraphSigma0Stat10051005->GetXaxis()->SetLabelFont(42);
    Graph_Graph_GraphSigma0Stat10051005->GetXaxis()->SetLabelSize(0.035);
    Graph_Graph_GraphSigma0Stat10051005->GetXaxis()->SetTitleSize(0.035);
    Graph_Graph_GraphSigma0Stat10051005->GetXaxis()->SetTitleFont(42);
    Graph_Graph_GraphSigma0Stat10051005->GetYaxis()->SetLabelFont(42);
    Graph_Graph_GraphSigma0Stat10051005->GetYaxis()->SetLabelSize(0.035);
    Graph_Graph_GraphSigma0Stat10051005->GetYaxis()->SetTitleSize(0.035);
    Graph_Graph_GraphSigma0Stat10051005->GetYaxis()->SetTitleFont(42);
    Graph_Graph_GraphSigma0Stat10051005->GetZaxis()->SetLabelFont(42);
    Graph_Graph_GraphSigma0Stat10051005->GetZaxis()->SetLabelSize(0.035);
    Graph_Graph_GraphSigma0Stat10051005->GetZaxis()->SetTitleSize(0.035);
    Graph_Graph_GraphSigma0Stat10051005->GetZaxis()->SetTitleFont(42);
    gre->SetHistogram(Graph_Graph_GraphSigma0Stat10051005);
    
    gre->Draw("pz");
    
    Double_t GraphSigma0Syst_fx1006[1] = {
        1.192};
    Double_t GraphSigma0Syst_fy1006[1] = {
        1.161};
    Double_t GraphSigma0Syst_fex1006[1] = {
        0.03};
    Double_t GraphSigma0Syst_fey1006[1] = {
        0.038};
    gre = new TGraphErrors(1,GraphSigma0Syst_fx1006,GraphSigma0Syst_fy1006,GraphSigma0Syst_fex1006,GraphSigma0Syst_fey1006);
    gre->SetName("GraphSigma0Syst");
    gre->SetTitle("GraphSigma0Syst");
    gre->SetFillColor(1);
    gre->SetFillStyle(0);
    gre->SetLineColor(kGreen+2);
    gre->SetLineWidth(2);
    ...
    TH1F *Graph_Graph_GraphSigma0Syst10061006 = new TH1F("Graph_Graph_GraphSigma0Syst10061006","GraphSigma0Syst",100,1.4958,1.5678);
    Graph_Graph_GraphSigma0Syst10061006->SetMinimum(1.5862);
    Graph_Graph_GraphSigma0Syst10061006->SetMaximum(1.7038);
    Graph_Graph_GraphSigma0Syst10061006->SetDirectory(0);
    Graph_Graph_GraphSigma0Syst10061006->SetStats(0);
    
    ci = TColor::GetColor("#000000");
    Graph_Graph_GraphSigma0Syst10061006->SetLineColor(ci);
    Graph_Graph_GraphSigma0Syst10061006->GetXaxis()->SetLabelFont(42);
    Graph_Graph_GraphSigma0Syst10061006->GetXaxis()->SetLabelSize(0.035);
    Graph_Graph_GraphSigma0Syst10061006->GetXaxis()->SetTitleSize(0.035);
    Graph_Graph_GraphSigma0Syst10061006->GetXaxis()->SetTitleFont(42);
    Graph_Graph_GraphSigma0Syst10061006->GetYaxis()->SetLabelFont(42);
    Graph_Graph_GraphSigma0Syst10061006->GetYaxis()->SetLabelSize(0.035);
    Graph_Graph_GraphSigma0Syst10061006->GetYaxis()->SetTitleSize(0.035);
    Graph_Graph_GraphSigma0Syst10061006->GetYaxis()->SetTitleFont(42);
    Graph_Graph_GraphSigma0Syst10061006->GetZaxis()->SetLabelFont(42);
    Graph_Graph_GraphSigma0Syst10061006->GetZaxis()->SetLabelSize(0.035);
    Graph_Graph_GraphSigma0Syst10061006->GetZaxis()->SetTitleSize(0.035);
    Graph_Graph_GraphSigma0Syst10061006->GetZaxis()->SetTitleFont(42);
    gre->SetHistogram(Graph_Graph_GraphSigma0Syst10061006);
   ...
   TLegend *leg = new TLegend(0.2,0.73,0.46,0.95,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("GraphppStat","pp 7 TeV (INEL),     #Sigma^{0}","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   tex->SetLineWidth(2);
    //tex->SetTextColor(kGray+2);
   tex->Draw();
    tex = new TLatex(1.19,0.5,"#Sigma^{0}");
    tex->SetTextFont(42);
    tex->SetTextSize(0.04);
    tex->SetLineWidth(2);
    //tex->SetTextColor(kGray+2);
   ...
   //legend
   Double_t GraphSigmaStarxLegend[1] = {1.35};
   Double_t GraphSigmaStaryLegend[1] = {2.7};
  ...
  /* Double_t GraphXiStarxLegend[1] = {0.61};
   ...
   pt->SetTextFont(42);
   pt->SetTextSize(0.045);
   Text = pt->AddText("#Sigma^{0} in pp 7TeV (INEL)");
   //pt->Draw();
   ...
   c->SetSelected(c);
   c->ToggleToolBar();
    c->SaveAs("PAPER_pT_Mass.gif");
    c->SaveAs("PAPER_pT_Mass.eps");
}
